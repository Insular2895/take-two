...
| C13 | OPRA interface and paper record | CLOSED_INTERFACE_ONLY | `reports/pre_opra/opra_interface_readiness_2026-08-08.json`; `docs/validation/OPRA_FINAL_VALIDATION_PLAN.md` | IBKR socket contract and immutable paper ledgers ready; entitlements/licence unconfirmed, no connection, Phase M not started |
