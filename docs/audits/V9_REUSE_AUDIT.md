...
| `scoring.py` | deterministic decomposed score and Pareto-first discipline | Keep scoring decomposed, but create three independent V10 profiles with versioned weights. |
