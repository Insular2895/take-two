# TTWO V9 options opportunity report

- Created: `2026-07-19T16:33:13.902259+00:00`
- Panels / variants: `8` / `25`
- Provider requests: `1193` (1187 cache hits)
- Ranking: `no_trade`
...
- `budget_single_long_h30_dte270__budget_single_call_plus05_balanced:bull_call_spread`: `blocked`, accuracy unavailable; insufficient train observations ; insufficient test observations ; coverage below configured minimum ; holdout validation did not pass
- `budget_staged_short_h05_dte45__budget_short_call_plus10:bull_call_spread`: `blocked`, accuracy unavailable; insufficient train observations ; insufficient test observations ; coverage below configured minimum ; holdout validation did not pass ; no listed call within 5% of target K+10%
- `budget_staged_medium_h20_dte150__budget_medium_call_plus55:bull_call_spread`: `blocked`, accuracy unavailable; insufficient train observations ; insufficient test observations ; coverage below configured minimum ; holdout validation did not pass ; no listed call within 5% of target K+55%
- `budget_staged_long_h30_dte270__budget_long_call_plus30_tight:bull_call_spread`: `blocked`, accuracy 0.0% [0.0%, 79.3%]; test median return below configured minimum ; test drawdown above configured maximum ; test worst loss above configured maximum ; deflated Sharpe probability below configured minimum ; train/test stability gap above configured maximum ; holdout validation did not pass
